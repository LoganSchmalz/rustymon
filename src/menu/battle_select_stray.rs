...
impl BattleSelectStray {
    pub fn new() -> BattleSelectStray {
        let stray = [Some(String::from("Carerus")), Some(String::from(" ")), Some(String::from("Rubridum")), Some(String::from("Omikae"))]; //currently hardcoding the names, will change later
